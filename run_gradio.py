...
def add_file_func(files, target_dir=DEFAULT_DB_PATH):
    """
    ...
    logger.info(f"Files added: {files}")
    ...
    with gr.Row():
        with gr.Column(scale=4):
            ...
            with gr.Row():
                ...
                db_wo_his_btn = gr.Button("Chat db ")
